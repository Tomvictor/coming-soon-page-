...
<head>
	...
	<title>Build From Zero - Coming Soon</title>
	
    <link name="author" href="Faisal Russel(russel365)" />
    <meta name="description" content="Buildfromzero.com, Electronics projects, Free examples, Simple coding, Learn to build, Electronics startup kochi, Startup village Kochi, Technorip">
...
<!-- Contact Icon end here -->
	...
	<section class="container main-wrapper">
		...
		<section id="logo" class="fade-down">
			<a href="#" title="Build From Zero|Projects Coming Soon H">
            	<img src="img/logo.png" alt="Buildfromzero|Projects">
            </a>
		</section>
		<!-- Logo end here -->
		<!-- Slogan start here -->
		...
		<footer class="fade-down">        
			<p class="footer-text">&copy; Buildfromzero 2015, All Rights Reserved.</p>
		</footer>
		<!-- Footer end here -->
	</section>
<!-- About start here -->
    ...
    <div class="modal-dialog modal-lg">
      <div class="modal-content pop-up pop-up-cnt">
        ...
        if(isset($_POST['submit'])){
        	...
        	$to="tom@buildfromzero.com"; // Add your e-mail here
        	if($code!=$captcha){
        ...
        <div class="clearfix cnt-wrap">
          <div class="col-md-4 col-sm-4">
            ...
            <h4>Phone</h4>
            <p><br />Phone: (+91) 9995060098<br /></p>
          </div>

          <div class="col-md-4 col-sm-4">      
            <i class="fa fa-envelope-o"></i>
            <h4>Email</h4>
            <p>cto@technorip.com<br />tom@buildfromzero.com</p>
          </div>
          <div class="col-md-4 col-sm-4">
            <i class="fa fa-map-marker"></i>
            <h4>Technorip</h4>
            <p>Startup Village, <br>
              Kalamassery <br>
              Kochi,683503</p>
            </div>
          </div>
